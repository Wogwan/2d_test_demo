...
%     smrplot(c5s,0,xran,[1000 400],'r-');
    ...
    smrplot(hinit,0,xran,[1500 400],'c-');
    axis(xran)
...
Vdot = hdot;
F = [sos(L1), sos(L2), sos(hdot + L1*v), sos(-Vdot + L2*h-htol), htol>=0];
