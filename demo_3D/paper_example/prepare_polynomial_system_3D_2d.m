...
dxdt2 = 0;
X = [1];
[mean2,hyp2,delta2,rmse2] = gpr_xdot2_3D(x_initial,y1,xtest_initial,y2_test,it,noise,poly_deg);            % GP learning for the xdot2 dynamic systems
pvar x1 x2 x3
...
f_output = [f1;f1_appro+dxdt2;f3_appro+dxdt3];
toc
%%
% %%
% figure(667);clf;
